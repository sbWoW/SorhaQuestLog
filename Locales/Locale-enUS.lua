...
L["Zones"] = true
L["Quest Info Colour"] = true
L["Sets the color for the info text ('hidden') for quests"] = true
L["Zone Info Colour"] = true
L["Sets the color for the info text ('hidden') of each zone"] = true
L["Hidden"] = true
